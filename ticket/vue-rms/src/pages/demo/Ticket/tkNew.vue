            ...
            <div class="search-box">
                ...
                <el-row style="margin-bottom: 0px;">
                    ...
                    <el-col :span="8" align="center">
                        ...
                        <!--                            <el-button class="myButtonQ" size="mini" type="primary" @click="findTicket" icon="el-icon-search">查询-->
                        <!--                            </el-button>-->
                        <!--                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-->
                        <!--                            <el-tooltip effect="light" content="刷新" placement="right"></el-tooltip>-->
                        <!--                            <el-button class="myButtonR" size="mini" type="success" @click="refresh" icon="el-icon-refresh">-->
                        <!--                                刷新-->
                        <!--                            </el-button>-->
                        <!--                        </el-badge>-->
                    </el-col>
                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">
                        <router-link style="color:#0b6dd8;text-decoration:none;"
                                     :to="{name:'demo-tkDetail', query:{id: scope.row.id, backroute: '/demo/tkNew'}}">
                            {{scope.row.tkId}}
                        </router-link>
                    </template>
                </el-table-column>
...
<script>
    ...
    export default {
        ...
        methods: {
            show(pageNo) {
                getRequest("/ticket/findNew?id=" + this.id.trim() +
            ...
            refresh() {
                ...
                // this.operatorName = "";
                // this.status = "";
                // getRequest("/ticket/findNew").then(res => {
                //     if (res.status === 200) {
                //         this.total = res.data.extend.total;
                //         this.data = Array.from(res.data.extend.ticket);
                //         this.currentPage = 1;
            ...
            // tkDetail({row}) {
            //     this.$router.push({name: 'demo-tkDetail', query: {id: row.id, backroute: '/demo/tkNew'}})
            // },
