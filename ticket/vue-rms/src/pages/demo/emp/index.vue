    ...
    <d2-container>
        ...
        <el-dialog
            ...
            <el-form :inline="true" class="demo-form-inline">
                ...
                <el-form-item label="员工姓名" v-for="n in 3" :key="n">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            show(pageNo) {
                getRequest("/emp/show?pageNo=" + pageNo + "&name=" + this.emp4search).then(res => {
                    if (res.status === 200) {
            ...
            //搜索
            search() {
                getRequest("/emp/show?name=" + this.emp4search).then(
                    res => {
                        if (res.status === 200) {
                            this.data = Array.from(res.data.emp);
                            this.total = res.data.total;
