                        ...
                        <div class="search-box">
                            <el-row style="margin-top: 10px; margin-bottom: 10px;">
                                <el-col :span="20" align="center">
                                    <el-input placeholder="请填写工单编号或者工单编号末三位数字..."
                                ...
                                <el-col :span="4" align="right">
                                    <el-tooltip class="item" effect="light" content="查询"></el-tooltip>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            tkDetail() {
                var self = this;
                if (self.ticketId === undefined || self.ticketId.trim() === "") {
                    self.ticketId = '';
                    self.$message.warning('请填写工单编号或者工单编号末三位数字!');
                    return;
                }
                this.$router.push({name: 'demo-tkDetail', query: {id: self.ticketId.trim(), backroute: '/index'}})
            },
        },
        data() {
            return {
