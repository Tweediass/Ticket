        ...
        <div class="d2-layout-header-aside-content" flex="dir:top">
          ...
          opacity: this.searchActive ? 0.5 : 1
                ...
                <div class="logo-group" :style="{width: asideCollapse ? asideWidthCollapse : asideWidth}" flex-box="0">
                    ...
                    <img v-else :src="`${$baseUrl}image/theme/${themeActiveSetting.name}/logo/logo(new).png`">
                </div>
                ...
                <div class="d2-header-right" flex-box="0">
                    ...
                    <el-badge style="font-size: 18px;margin-right: 10px" :is-dot="isDot">
                        <i class="fa fa-bell-o" @click="goAnnouncement" style="cursor: pointer"></i>
                    </el-badge>
                    <d2-header-error-log/>
                        ...
                        <div v-show="!searchActive" class="d2-theme-container-main-layer" flex="dir:top">
                            ...
                            <div class="d2-theme-container-main-header" flex-box="0">
                                ...
                                <el-breadcrumb separator-class="el-icon-arrow-right" style="font-size: 18px;" >
                                    ...
                                    <el-breadcrumb-item
                                            v-text="this.$router.currentRoute.meta.title"></el-breadcrumb-item>
                                </el-breadcrumb>
                            </div>
                            <!-- 页面 -->
...
<script>
    ...
    export default {
        ...
        methods: {
          ...
          goAnnouncement() {
            this.$router.push({path: '/demo/Announcement'});
          },
            ...
            loadNF() {
                var self = this;
                var msg = 'load fail';
                getRequest("/announcement/check").then((resolve, reject) => {
                    if (resolve && resolve.status === 200) {
                        ...
                        if (resolve.data.code === 400) {
                            ...
                            self.isDot = resolve.data.extend.flag;
                        }
                    }
                }).catch(err => {
                        console.log('err: ', err);
