<template>
  <div class="d2-layout-header-aside-menu-side" style="display: flex;justify-content: flex-start;width: 200px;text-align: left;">
    <el-menu
      ...
      <template v-for="(menu, menuIndex) in aside">
        ...
        <d2-layout-header-aside-menu-sub v-else :menu="menu" :key="menuIndex" class="cust-submenu"/>
      </template>
    </el-menu>
